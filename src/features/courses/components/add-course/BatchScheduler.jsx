...
const BatchScheduler = ({ batches, onChange }) => {
    ...
    const handleAddBatch = () => {
        if (newBatch.name && newBatch.startDate) {
            onChange([...batches, { ...newBatch, id: Date.now() }]);
            setNewBatch({
                name: '',
                startDate: '',
                endDate: '',
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-5 rounded-xl border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <input
                        ...
                        placeholder="Batch Name (e.g. Weekend Batch A)"
            ...
            <div className="space-y-4">
                {batches.map((batch, index) => (
                    <div key={batch.id} className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all animate-fadeIn">
