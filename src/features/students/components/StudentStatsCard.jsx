...
import { Users, BookOpen, Award, TrendingUp as TrendingUpIcon, TrendingDown } from 'lucide-react';
...
const StudentStatsCard = ({ stat }) => {
    const Icon = iconMap[stat.icon];
    const TrendIcon = stat.trend === 'up' ? TrendingUpIcon : TrendingDown;
